const HUBS = [
  ...
  },
  {
    ...
    integrated:['사사시대 전체 결론: 구원은 반복되었지만 근본 문제는 남아 있음','참 왕에 대한 필요가 드러남','통일왕국과 다윗 언약을 향해 흐름이 열린다'],
    refs:['사사기 17장','사사기 18장','사사기 19장','사사기 20장','사사기 21장','사무엘상 8장'],
    message:'사사기의 마지막은 충격적이다. 왕이 없다는 말은 단순히 군주가 없다는 뜻이 아니라, 하나님의 말씀을 기준으로 삼는 질서가 무너졌다는 뜻이다. 그래서 사사시대는 통일왕국을 향해 문을 연다.',
